...
import { Search, Details, Bookmarks } from './pages';
import { logo } from './assets';

const App = () => (
  <div className='bg bg-[#021627]'>
    <BrowserRouter>
      <header className="w-full flex justify-between items-center sm:px-8 px-4 pt-6">
        <Link to="/">
          <img src={logo} alt="logo" className="w-28 object-contain" onClick={()=>window.location.href='http://127.0.0.1:5173/'}/>
        </Link>
        <Link to="/bookmarks">
          <span className="font-inter font-medium text-[#bfdbf7] px-4 py-2 neon">Bookmarks</span>
        </Link>
      </header>
      <main className="sm:p-8 px-4 w-full min-h-[calc(100vh-60px)]">
        <Routes>
      ...
      <footer className='text-white py-4'>
        <div className='inline-block pr-40'>
          <a className='text-xs px-3'>&#169;2023 Pokédex, Inc.</a>
        </div>
        <div className='felx inline-block text-xs align-center'>
          <a href="#" className='px-4 hover:underline'>Terms Of Use</a>
          <a href="#" className='px-4 hover:underline'>Privacy Policy</a>
          <a href="#" className='px-4 hover:underline'>Cookie Page</a>
          <a href="#" className='px-4 hover:underline'>Contact Us </a>
        </div>
        <div className='inline-block float-right pr-12'>
          <a href="#" aria-label="facebook" className='inline-block px-3'>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="svg-icon svg-icon-facebook-logo" data-name="Facebook">
              <path fillRule="evenodd" clipRule="evenodd" d="M13.9868 13.1621V21.9841H10.0418V13.1621H6.8418V9.51207H10.0468V6.73207C10.0468 3.56707 11.9318 1.82007 14.8148 1.82007C15.7616 1.83321 16.7061 1.91577 17.6408 2.06707V5.17307H16.0448C15.4952 5.10007 14.9422 5.28088 14.5419 5.66447C14.1415 6.04807 13.9373 6.59284 13.9868 7.14507V9.51207H17.4868L16.9278 13.1621H13.9868Z" fill="white">
              </path>
            </svg>
          </a>
          <a href="#" aria-label="instagram" className='inline-block px-3'>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="svg-icon svg-icon-instagram-logo" data-name="Instagram">
